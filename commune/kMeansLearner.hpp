            ...
            try {
                ...
                if (jin.count("num_train_data")) {
                    p_learner_config->num_train_data =
                        static_cast<decltype(p_learner_config->num_train_data)>(
                            jin["num_train_data"]);
                }
                ...
                if (jin.count("load_result")) {
                    ...
                    if (jin.count("load_result_file")) {
                        p_learner_config->load_result_file =
                            static_cast<decltype(p_learner_config->load_result_file)>(
                                jin["load_result_file"]);
                    }
                }
